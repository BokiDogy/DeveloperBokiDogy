...
namespace MVCTEST.MVC
{
    public class Routers : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string mname = urls[urls.Length - 1].Substring(0, urls[urls.Length - 1].IndexOf('?'));
            ...
            if (Exist)
            {
                ...
                if (result != null)
                {
                    ...
                    if (rt.FullName.ToUpper().Contains("SYSTEM") && (!rt.FullName.ToUpper().Contains("SYSTEM.OBJECT")))
                    {
